...
public class LevelBoundary : MonoBehaviour
{
    ...
    public float LeftBorder//левая ограничительная экранная точка
    {
        get
        {
    ...
    public float RightBorder//правая ограничительная экранная точка
    {
        get
        {
...
#if UNITY_EDITOR
    private void OnDrawGizmos()//отображение границ уровня
    {
